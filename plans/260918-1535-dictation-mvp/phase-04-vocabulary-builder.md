...
- **Web**: popover từ (`features/vocab/word-popover.tsx`), trang Sổ tay, trang Ôn tập (phím Space lật, 1–4 đánh giá), phát câu ngữ cảnh bằng lại `useSegmentPlayer` với 1 segment.
...
- Create (web): `src/features/vocab/{word-popover.tsx,notebook-page.tsx,review-page.tsx,clickable-transcript.tsx}`
